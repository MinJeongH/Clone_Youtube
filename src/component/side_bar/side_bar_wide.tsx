    ...
    <section className={styles.sidebarWide}>
      ...
      <div className={styles.barcontent}>
        ...
        <div className={styles.videoguide}>
          ...
          <button className={styles.button}>
            <span className={`material-icons ${styles.history}`}>history</span>
            시청 기록
          </button>
          <button className={styles.button}>
        ...
        <div className={styles.seemoreguide}>
          ...
          <button className={styles.button}>
            <span className={`material-icons ${styles.study}`}>lightbulb</span>
            학습
          </button>
          <button className={styles.button}>
        ...
        <div className={styles.setguide}>
          <button className={styles.button}>
            <span className={`material-icons ${styles.setting}`}>settings</span>
            설정
          </button>
          <button className={styles.button}>
